...
* Solr Cell libraries (+dist/apache-solr-cell-1.4.X.jar+ and +contrib/extraction/*.jar+ from the standard Solr distribution) placed in the +/solr/lib+ directory as created by the Sunspot gem, in development environment. Your production setup might vary.

* Adjustements to the Solr +schema.xml+:
